...
### 06-http-cloudevents
HTTP pub/sub using message/http adapter. Demonstrates receiving CloudEvents via HTTP (binary or structured mode), processing with typed handlers, and publishing results with automatic batching.
