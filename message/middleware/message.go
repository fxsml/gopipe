...
) pipe.MiddlewareFunc[*message.Message, *message.Message] {
	return func(proc pipe.Processor[*message.Message, *message.Message]) pipe.Processor[*message.Message, *message.Message] {
		return pipe.NewProcessor(
