...
This plan also lays the foundation (middleware ordering) for the [inbox-outbox plan](inbox-outbox.md).
...
- [ ] Commit happens before broker ack (depends on Task 1 middleware reordering)
